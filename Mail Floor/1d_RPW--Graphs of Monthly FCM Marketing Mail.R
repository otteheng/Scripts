...
graph_path <- "./Mail Floor/Code/Tables & Figures/1d"
...
rpw_raw <- read_xlsx(paste(vol_perc_path, "21-9_RPW Factors Jul. 2019-SEPTEMBER. 2021_10.19.21_FINAL - Copy.xlsx",
                          sep = "/"), sheet = "Series_VolRVCformat", range = "A5:BU14")
...
#3.1: Basic graph of volume for FCM by month from FY 2018-2021
    ...
    graph.3.1 <- rpw.long.wide %>% 
      ggplot(aes(x=month, group = 1)) +
        ...
        ##1. Line
        geom_line( aes(y=FCM_2018, color = "FY 2018"), size=1) +
        geom_line( aes(y=FCM_2019, color = "FY 2019"), size=1) +
        geom_line( aes(y=FCM_2020, color = "FY 2020"), size=1) +
        geom_line( aes(y=FCM_2021, color = "FY 2021"), size=1) +
