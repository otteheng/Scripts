...
# -> Notes: Figure used in Mail Trends is in Step 6
...
mail_trends_path <- "./Mail Trends/Sources/2022-02/Excel tables"
...
# Used in Mail Trends slide "Historic Mail Volumes" 
#   Mail Trends November 2021 and February 2022
